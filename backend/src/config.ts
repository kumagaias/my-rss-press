export const config = {
   ...
   * - Note: Uses APAC inference profile for on-demand throughput
   * 
   ...
   */
  bedrockModelIdLite: process.env.BEDROCK_MODEL_ID_LITE || 'apac.amazon.nova-lite-v1:0',
  bedrockModelIdMicro: process.env.BEDROCK_MODEL_ID_MICRO || 'apac.amazon.nova-micro-v1:0',
