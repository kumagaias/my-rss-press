...
const INITIAL_DATA = {
  categories: [
    ...
    },
    {
      ...
      locale: 'en' as const,
      displayName: 'Sports',
      keywords: ['sports', 'football', 'basketball', 'soccer', 'athletics', 'sport'],
      order: 4,
      isActive: true,
    },
    {
      categoryId: 'entertainment-en',
      parentCategory: 'entertainment',
      locale: 'en' as const,
      displayName: 'Entertainment',
      keywords: ['entertainment', 'movies', 'music', 'celebrities', 'TV', 'film', 'cinema', 'celebrity'],
      order: 5,
      isActive: true,
    },
    {
      categoryId: 'health-en',
      parentCategory: 'health',
      locale: 'en' as const,
      displayName: 'Health',
      keywords: ['health', 'fitness', 'wellness', 'medical', 'medicine', 'healthcare', 'wellbeing'],
      order: 6,
      isActive: true,
    },
    {
      ...
      locale: 'en' as const,
      displayName: 'Science',
      keywords: ['science', 'research', 'discovery', 'space', 'scientific', 'astronomy', 'physics'],
      order: 7,
      isActive: true,
    },
    {
      categoryId: 'lifestyle-en',
      parentCategory: 'lifestyle',
      locale: 'en' as const,
      displayName: 'Lifestyle',
      keywords: ['lifestyle', 'food', 'travel', 'fashion', 'cooking', 'recipe', 'tourism', 'style'],
      order: 8,
      isActive: true,
    },
    ...
    },
    {
      ...
      locale: 'ja' as const,
      displayName: 'スポーツ',
      keywords: ['スポーツ', 'サッカー', '野球', 'バスケットボール', '運動', 'スポーツニュース'],
      order: 4,
      isActive: true,
    },
    {
      categoryId: 'entertainment-ja',
      parentCategory: 'entertainment',
      locale: 'ja' as const,
      displayName: 'エンターテインメント',
      keywords: ['エンターテインメント', '映画', '音楽', '芸能', 'テレビ', 'エンタメ', '芸能人', 'TV'],
      order: 5,
      isActive: true,
    },
    {
      categoryId: 'health-ja',
      parentCategory: 'health',
      locale: 'ja' as const,
      displayName: '健康',
      keywords: ['健康', 'フィットネス', '医療', 'ウェルネス', '健康管理', '医学', 'ヘルスケア'],
      order: 6,
      isActive: true,
    },
    {
      categoryId: 'science-ja',
      parentCategory: 'science',
      locale: 'ja' as const,
      displayName: '科学',
      keywords: ['科学', '研究', '発見', '宇宙', '科学技術', '天文学', '物理学'],
      order: 7,
      isActive: true,
    },
    {
      categoryId: 'lifestyle-ja',
      parentCategory: 'lifestyle',
      locale: 'ja' as const,
      displayName: 'ライフスタイル',
      keywords: ['ライフスタイル', '食', '旅行', 'ファッション', '料理', 'レシピ', '観光', 'グルメ'],
      order: 8,
      isActive: true,
    },
  ],
  ...
  feeds: [
    ...
    },
    {
      ...
      description: 'Travel and lifestyle',
      language: 'en',
      priority: 2,
      isActive: true,
    },
    
    // Entertainment feeds (JA)
    {
      categoryId: 'entertainment-ja',
      url: 'https://www.cinematoday.jp/rss/news.rdf',
      title: 'シネマトゥデイ',
      description: '映画とエンターテインメントのニュース',
      language: 'ja',
      priority: 1,
      isActive: true,
    },
    ...
    {
      categoryId: 'health-ja',
      url: 'https://www.healthcare.omron.co.jp/rss/resource.xml',
      title: 'オムロン ヘルスケア',
      description: '健康情報とアドバイス',
      language: 'ja',
      priority: 1,
      isActive: true,
    },
    ...
    {
      categoryId: 'science-ja',
      url: 'https://www.astroarts.co.jp/article/assets/atom.xml',
      title: 'アストロアーツ',
      description: '天文と宇宙のニュース',
      language: 'ja',
      priority: 1,
      isActive: true,
    },
    ...
    {
      categoryId: 'lifestyle-ja',
      url: 'https://www.elle.com/jp/rss/feed/',
      title: 'ELLE Japan',
      description: 'ファッションとライフスタイル',
      language: 'ja',
      priority: 1,
      isActive: true,
    },
    {
      categoryId: 'lifestyle-ja',
      url: 'https://www.hotpepper.jp/mesitsu/rss/index.xml',
      title: 'ホットペッパーグルメ',
      description: 'グルメと食の情報',
      language: 'ja',
      priority: 2,
      isActive: true,
    },
